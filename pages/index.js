      ...
      <Grid container stackable verticalAlign='middle'>
        <Grid.Row>
          ...
          <Grid.Column floated='right' width={6}>
            <Image bordered rounded size='large' src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR9mA4h-nC5RPHjRBvutsHdljnsMxZ8KacxxA&usqp=CAU' />
          </Grid.Column>
        </Grid.Row>
        <Grid.Row>
